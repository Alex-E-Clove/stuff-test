...
import KodvetLove from './KodvetLove';
...
export default function Footer(props: FooterProps) {
    ...
    return (
        <footer className="bg-stuff-green/30" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 sm:pb-8 lg:px-8 lg:py-16 lg:pb-8">
                ...
                <div className="mt-12 text-gray-600 text-center font-bold font-sans text-sm">
                    <p>&copy; StuFF - Studentkåren för utbildningsvetenskap och filosofisk fakultet vid Linköpings universitet</p>
                    <p>Org nr: 822001-0535</p>
                </div>
                <KodvetLove></KodvetLove>
            </div>
        </footer>
    );
}
